...
public class RatPolyStackTest{
    ...
    private void assertStackIs(RatPolyStack s, String desc) {
        ...
        for (int i = 0; i < desc.length(); i++) {
            ...
            assertTrue(eqv(p, constantPoly(c)), asstr);
        }
    }
    ...
    public void testDifferentiate() {
        ...
        stk1.differentiate();
        stk1.differentiate();
        assertTrue (stk1.size() == 3, "Test if stack size changes");
        ...
        stk1.differentiate();
        assertTrue (stk1.pop().toString().equals ("4"), "Test simple differentiate1");
        stk1.differentiate();
        assertTrue (stk1.pop().toString().equals ("0"), "Test simple differentiate2");
        stk1.differentiate();
        assertTrue ( stk1.pop().toString().equals ("15*x^4"), "Test simple differentiate3");    
    }
    ...
    public void testIntegrate() {
        ...
        stk1.integrate();
        assertTrue (stk1.size() == 3, "Test if stack size changes");
        assertTrue (stk1.pop().toString().equals ("1/24*x^4"), "Test simple integrate1");
        ...
        stk1.integrate();
        assertTrue (stk1.pop().toString().equals ("4*x"), "Test simple integrate1");
        stk1.integrate();
        assertTrue (stk1.pop().toString().equals ("7*x"), "Test simple integrate2");
        stk1.integrate();
        assertTrue (stk1.pop().toString().equals ("3*x^5"), "Test simple integrate3");
    }
